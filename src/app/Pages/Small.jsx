...
export default function Small() {
  return (
    <div className="flex-col flex justify-center border-2ing"> 
             <div className="pb-2 flex gap-2 flex-wrap border-2">
            ...
            <hr className="w-28"/>
            <div className="text-slate-300 pt-2 first-letter:uppercase text-sm w-full leading-normal max-w-xl border-2">
